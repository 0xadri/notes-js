...
Watch out, install the correct modules to have access to the relevant workflows i.e. document-project is in the BMM module

Typically you want to install both:
- `BMB: BMad Builder - Agent, Workflow and Module Builder`
- `BMM: BMad Method Agile-AI Driven-Development`

If you are on a brownfield project, you prob want to run:
